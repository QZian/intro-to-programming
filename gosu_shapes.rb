...
class DemoWindow < Gosu::Window
  ...
  def draw
    ...
    draw_quad(0, 0, 0xff_ffffff, LENGTH, 0, 0xff_ffffff, 0, WIDTH, 0xff_ffffff, LENGTH, WIDTH, 0xff_ffffff, ZOrder::BACKGROUND)
    ...
    #add
    draw_triangle(320, 150, Gosu::Color::GREEN, 200, 240, Gosu::Color::RED, 440, 240, Gosu::Color::BLUE, ZOrder::MIDDLE, mode=:default)

    Gosu.draw_rect(220, 50, 200, 100, Gosu::Color::YELLOW, ZOrder::TOP, mode=:default)

    img = Gosu::Image.new(Circle.new(320)) 
    img.draw(0, 240, ZOrder::TOP, 1.0, 0.5, Gosu::Color::RED)
